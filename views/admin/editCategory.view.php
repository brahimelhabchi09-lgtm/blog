     <main class="flex-1 overflow-y-auto bg-background-dark p-4 md:p-8 scroll-smooth">
                <div class="mx-auto max-w-4xl flex flex-col gap-8">
                    ...
                    <div class="rounded-xl border border-[#543b43] bg-[#1a0b0f] shadow-2xl overflow-hidden">
                        ...
                        <form class="p-8 flex flex-col gap-6" action="/admin/category/update" method="POST">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="flex flex-col gap-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input class="w-full bg-[#221016] border border-[#543b43] rounded-lg py-3 pl-10 pr-4 text-white focus:ring-primary focus:border-primary transition-all font-body" placeholder="Enter category name..." type="text" value="<?= $category->getName() ?>" name="name" />
                                    </div>
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <textarea class="w-full bg-[#221016] border border-[#543b43] rounded-lg p-4 text-white focus:ring-primary focus:border-primary transition-all font-body" placeholder="Describe the purpose of this magical category..." name="description"><?= $category->getDescription() ?></textarea>
                            </div>
