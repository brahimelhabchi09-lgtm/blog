    ...
    <main class="flex flex-1 flex-col overflow-y-auto bg-background-dark">
        ...
        <div class="flex flex-1 flex-col gap-8 p-6 md:px-12 md:py-8 lg:px-16 lg:py-10 max-w-7xl mx-auto w-full">
            ...
            <form class="space-y-6" action="/author/article/store" method="POST" enctype="multipart/form-data" id="article-form">
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                    <div class="lg:col-span-2 space-y-6">
                        <div class="space-y-2">
                            ...
                            <input class="w-full bg-surface-dark border-surface-border text-white text-xl md:text-2xl font-display placeholder-text-muted/30 focus:ring-primary focus:border-primary rounded-xl py-4 px-6" id="scroll-title" placeholder="e.g. The Secrets of Transfiguration Revealed..." type="text" name="title" />
                        </div>
                        <div class="space-y-2">
